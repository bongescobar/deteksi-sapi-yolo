...
<div class="top-nav">
    ...
    <div style="font-size:12px;color:rgba(255,255,255,0.5);letter-spacing:0.08em;">
        YOLOv8 · 4 Jenis Sapi
    </div>
</div>
""", unsafe_allow_html=True)
...
def prediksi(image, conf_threshold):
    ...
    with col_img:
        ...
        if jumlah_objek == 0:
            st.warning("⚠️ Tidak ada sapi terdeteksi. Coba turunkan confidence threshold.")
        else:
...
with tab_info:
    ...
    Foto sapi di bawah diambil dari folder <code>images/</code> di repositori GitHub.
    Ganti file foto di folder tersebut untuk memperbarui tampilan secara permanen.
    </p>
    """, unsafe_allow_html=True)
